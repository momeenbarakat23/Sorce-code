...
# SEC Floating Feature configuration file for Galaxy Note20 Ultra (c2s)
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_SPEN_FCC_ID=A3LEJPN980
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMN986B,24_A3LSMN986B1
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE=DC 9 V; 2.77 A
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_c2s_exynos990
...
SEC_FLOATING_FEATURE_COMMON_CONFIG_SWLENS_DISTORTION_CORRECTION=canvas_c2,SAK2L3
